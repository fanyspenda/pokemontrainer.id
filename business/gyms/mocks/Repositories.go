...
func (_m *Repositories) AddGym(ctx context.Context, name string, address string) (gyms.Domain, error) {
...
func (_m *Repositories) GetGyms(ctx context.Context) ([]gyms.Domain, error) {
	ret := _m.Called(ctx)
...
func (_m *Repositories) UpdateGym(ctx context.Context, gymID int, name string, address string) (gyms.Domain, error) {
