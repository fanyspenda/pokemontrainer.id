...
func (_m *UseCase) AddGym(ctx context.Context, trainerID int, gymID int) (trainers.Domain, error) {
...
func (_m *UseCase) CatchPokemon(ctx context.Context, ID int, pokemonID int) (trainers.Domain, error) {
...
func (_m *UseCase) GetFirstBall(ctx context.Context, trainerID uint) (pokeballs.Domain, error) {
...
func (_m *UseCase) GetTrainers(ctx context.Context) ([]trainers.Domain, error) {
	ret := _m.Called(ctx)
...
func (_m *UseCase) Login(ctx context.Context, username string, password string) (trainers.Domain, error) {
...
func (_m *UseCase) Register(ctx context.Context, name string, address string, username string, password string) (trainers.Domain, error) {
...
func (_m *UseCase) UpdateTrainer(ctx context.Context, trainerID int, name string, address string, username string, password string) (trainers.Domain, error) {
